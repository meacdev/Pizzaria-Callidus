...
function obterDescricaoCard(pizza: Pizza, compacto: boolean): string {
  if (!compacto || pizza.descricao.length <= 130) return pizza.descricao;
  ...
  return (
    <article className="card">
      ...
      <div className="detalhes">
        ...
        <p className="descricao-card">{obterDescricaoCard(pizza, compacto)}</p>
